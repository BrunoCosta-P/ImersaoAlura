...
function jogar() {
    ...
    if (cartas.length == 0){
        ...
        if (pontosJogador > pontosMaquina){
            htmlResultado = "<p class='resuldato-final'>Você venceu o jogo</p>"
        } else if(pontosJogador < pontosMaquina){
            htmlResultado = "<p class='resuldato-final'>Você perdeu</p>"
        } else {
            htmlResultado = "<p class='resuldato-final'>Você empatou com a maquina</p>"
        }
    } else {
